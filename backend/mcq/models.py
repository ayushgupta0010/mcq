...
class Question(models.Model):
    ...
    mcqOptionA = models.CharField(max_length=100, blank=True, null=True)
    mcqOptionB = models.CharField(max_length=100, blank=True, null=True)
    mcqOptionC = models.CharField(max_length=100, blank=True, null=True)
    mcqOptionD = models.CharField(max_length=100, blank=True, null=True)
